 ...
 * 
 * This is a mockup structure. Will be developed on
 *
 */
       ...
       */
        ...
        public function Check_Password($User_Input,$Hashed_Password,$Stored_Salt){
            ...
            if ($Hashed_Password !== $Hash){
                return array('Error Code' => "0", 'Error Message' => 'Passwords  Do Not Match');
            }
            return array("Error Code" => "1", "Error Message" => "Matching Passwords");
        }
